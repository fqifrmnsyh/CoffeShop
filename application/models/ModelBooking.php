...
class ModelBooking extends CI_Model
{
    ...
    {
    $this->db->where($where); return $this->db->get($table);
    }

    public function getOrderByLimit($table, $order, $limit)
    {
    $this->db->order_by($order, 'desc');
    $this->db->limit($limit); return $this->db->get($table);
    }
    ...
    {
        $this->db->query('CREATE TABLE IF NOT EXISTS booking_temp(id_booking varchar(12), tgl_booking DATETIME, email_user varchar(128), id_buku int)');
        //$this->db->query('CREATE TABLE IF NOT EXISTS temp(id_booking varchar(12), tgl_booking DATETIME, email_user varchar(128), id_buku int)');
    }
    ...
    public function selectJoin()
    {
        ...
        $this->db->join('buku', 'booking_detail.id_buku=buku.id'); return $this->db->get();
    }
