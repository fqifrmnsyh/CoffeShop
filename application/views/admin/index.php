      ...
      <div class="card border-bottom-danger shadow h-10 py-2 bg-white">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-dark text-uppercase mb-1">Admins</div>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-bottom-success shadow h-10 py-2 bg-white">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-dark text-uppercase mb-1">Total Stock</div>
    ...
    <div class="col-xl-4 col-md-6 mb-4">
      <div class="card border-bottom-primary shadow h-10 py-2 bg-white">
        <div class="card-body">
          <div class="row no-gutters align-items-center">
            <div class="col mr-2">
              <div class="text-md font-weight-bold text-dark text-uppercase mb-1">Sold</div>
              <div class="h1 mb-0 font-weight-bold text-dark">
              <?php
  ...
  <div class="row">
    <div class="table-responsive table-bordered col-sm-12 ml-auto mt-2">
      <div class="page-header">
        <span class="fas fa-users text-primary mt-2"><span style="font-weight: bold; font-family: arial;"> User Data</span></span>
        <a class="text-danger" href="<?php echo base_url('user/anggota'); ?>">
        <i class="fas fa-search mt-2 float-right"> Show</i></a>
      </div>
        ...
        <tbody class="bg-white">
          ...
          foreach ($anggota as $a) { ?>
            <tr>
              ...
              <!-- <td><?= $a['is_active']; ?></td> -->
              <td><?= date('Y-mm-d', $a['tanggal_input']); ?></td>
            </tr>
          <?php } ?>
        </tbody>
      </table>
    ...
    <div class="table-responsive table-bordered col-sm-12 ml-auto mr-auto mt-2">
      <div class="page-header">
        <span class="fas fa-users text-success mt-2"><span style="font-weight: bold; font-family: arial;"> Product Data</span></span>
        <!-- <span class="fas fa-book text-warning mt-2"> Data Item</span> -->
        <a href="<?= base_url('produk'); ?>"><i class="fas fa-search text-primary mt-2 float-right"> Show</i></a>
      </div>
